...
const CollectionDetailPage = () => {
  ...
  const {
    ...
    queryFn: async ({ pageParam = 1 }) => {
      ...
      // Ensure we return a consistent structure even if the response is empty
      return {
  ...
  // Safe access to pages data
  const collectibles = data?.pages.flatMap(page => page?.collectibles || []) || [];
  ...
  ].filter((link) => link.url !== null && link.url !== undefined && link.url !== "");
  ...
  if (isParamsLoading || (id && isQueryLoading)) {
                ...
                <div className="lg:pt-0 hidden lg:block">
                  <div className="grid grid-cols-2 md:flex md:justify-around xl:grid-cols-4 lg:grid w-full gap-8 md:gap-8 lg:gap-8 mt-4">
                    <div className="text-center md:text-left">
                      <h2 className="font-medium text-lg text-neutral100">Floor price</h2>
                      <div className="flex items-center justify-center md:justify-start mt-2">
                        ...
                        <p className="ml-2 font-bold text-lg md:text-xl text-neutral50">
                          <span>
                            {collectionData?.floor ? formatPrice(collectionData.floor) : "0"}
                          </span>{" "}
                          cBTC
                        </p>
                      </div>
                    ...
                    <div className="text-center md:text-left 2xl:border-l 2xl:border-neutral400 2xl:px-8 px-0 border-0">
                      <h2 className="font-medium text-lg text-neutral100">Total volume</h2>
                      <div className="flex items-center justify-center md:justify-start mt-2">
                        <Image
                          width={24}
                          height={20}
                        ...
                        <p className="ml-2 font-bold text-lg md:text-xl text-neutral50">
                          <span>
                            {collectionData?.volume ? formatPrice(collectionData?.volume) : "0"}
                          </span>{" "}
                          cBTC
                        </p>
                      </div>
          ...
          <div className="px-0 lg:px-12 text-lg font-normal text-neutral100 mt-10 lg:mt-14 xl:mt-6">
            <div className="lg:pt-0 block lg:hidden">
              <div className="grid grid-cols-2 md:flex md:justify-around xl:grid-cols-4 lg:grid w-full gap-8 md:gap-8 lg:gap-8">
                {/* Mobile stats items - same as desktop but shown on mobile */}
                {/* ... Mobile stats items (same structure as desktop version) ... */}
              </div>
            </div>
