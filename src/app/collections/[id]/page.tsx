                    ...
                    <CollectionActivityCard
                      ...
                      imageUrl={
                        currentAsset?.highResolutionImageUrl
                          ...
                          : "" // Provide a fallback empty string or default image URL
                      }
                      collectionName={
                        currentAsset?.collectionName || collection?.name || ""
                      }
                    />
                  ))
                ) : (
...
//   const { data: activityCollection = [] } = useQuery({
//     queryKey: ["activityData", id],
//     queryFn: () => getCollectionActivity(id),
//     enabled: !!id,
//   });
...
//                   activityCollection.map((item: any) => (
//                     <CollectionActivityCard
