    ...
    <>
      ...
      >
        ...
        <div className="pt-1">
          ...
          <div 
            className={`relative ${isListed ? "group" : ""} h-10 w-[248px] ${
              isListed ? "hover:border-hidden" : ""
            } border-t border-neutral400 hover:border-transparent`}
          >
            <div
              className={`flex justify-between py-4 ${
                isListed ? "group-hover:hidden" : "hover:border-hidden"
              }`}
            >
              {isListed ? (
                <>
                ...
                <div className="relative group w-full">
                  ...
                  <div
                    className={`group-hover:block hidden text-center cursor-pointer w-[248px] h-10 absolute inset-0 opacity-0 hover:opacity-100 transition-all duration-300 ease-in-out -top-4 left-0 text-white bg-white4 pt-2 pr-5 pb-2 pl-5 rounded-lg`}
                  >
                    View
                  </div>
                </div>
