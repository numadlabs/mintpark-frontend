...
const LaunchpadCard: React.FC<LaunchProps> = ({ data, id }) => {
  ...
  return (
    <Link href={`/launchpad/${id}`} className="block w-full">
      <div className="relative flex flex-col backdrop-blur-sm bg-gradient-to-br from-gradientStart to-transparent border border-neutral400 rounded-[20px] p-4 text-neutral00 transition-transform hover:scale-[1.02]">
