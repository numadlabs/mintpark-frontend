    ...
    return (
      <div className="max-w-2xl mx-auto text-center">
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-bold text-white mb-2">
            Uploading Trait Assets
          </h1>
          <p className="text-lightSecondary max-w-md mx-auto">
            Your trait assets are being uploaded to a critical storage system.
            This essential step is required to proceed with inscription.
          </p>
        </div>
        ...
        <div className="bg-darkSecondary border border-transLight4 rounded-xl p-6">
          <div className="flex justify-between items-center mb-4">
            ...
            <span className="text-white font-medium">
              {inscriptionData.progress.current} /{" "}
              {inscriptionData.progress.total}
            </span>
          </div>
            ...
            <div className="flex gap-3">
              ...
              <div className="text-left">
                <p className="text-white font-medium mb-1">
                  Please do not close or refresh tab
                </p>
                <p className="text-sm text-lightSecondary">
                  Do not close or refresh the tab. Doing so will require you to
                  upload your assets again from the start.
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-darkSecondary border border-transLight4 rounded-xl p-6 mb-8">
          ...
          <p className="text-lightSecondary mb-6">
            Track the real-time status of your Ordinal inscriptions as we record
            your assets on Bitcoin.
          </p>
          ...
          <div className="grid grid-cols-2 gap-6">
            ...
            <div>
              ...
              <p className="text-white font-medium">
                {inscriptionData.progress.estimatedTime}
              </p>
            </div>
          </div>
        </div>
