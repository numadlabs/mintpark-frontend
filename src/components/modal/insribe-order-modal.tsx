...
const InscribeOrderModal: React.FC<modalProps> = ({ open, onClose }) => {
      ...
      <DialogContent className="flex flex-col p-6 gap-6 max-w-[592px] w-full items-center">
        ...
        <div className="flex flex-col gap-3 border border-white8 rounded-2xl w-full px-5 pt-4 pb-5">
          ...
          <p className="text-lg2 text-neutral50 font-medium">
            d70b579600f5733beb604a2509d70af826991b4c
          </p>
        </div>
        <div className="grid grid-cols-2 gap-4 items-center w-full">
            <div className="border border-white8 rounded-2xl w-full px-5 pt-4 pb-5 flex flex-col gap-3">
                ...
                <p className="text-lg text-neutal50 font-medium">10,000</p>
            </div>
            <div className="border border-white8 rounded-2xl w-full px-5 pt-4 pb-5 flex flex-col gap-3">
                <p className="text-md text-neutral200 font-medium">Status:</p>
                <p className="text-lg text-neutal50 font-medium">Pending</p>
            </div>
        </div>
        <div className="h-[1px] w-full bg-white8" />
        ...
        <div className="flex flex-col gap-4 w-full">
            <div className="flex flex-row items-center justify-between w-full bg-white4 p-4 rounded-2xl">
                ...
                <p className="text-neutral50 text-lg font-medium">Pending...</p>
            </div>
            <div className="flex flex-row items-center justify-between w-full bg-white4 p-4 rounded-2xl">
                <div className="flex flex-row gap-3 items-center">
                    <div className="h-8 w-8 bg-white8 flex justify-center items-center rounded-[20px]">
                ...
                <p className="text-neutral50 text-md font-medium">Inscribing will start after payment is recieved</p>
            </div>
        </div>
        <div className="h-[1px] w-full bg-white8" />
        <p className="text-neutral200 text-md font-medium text-start w-full">You can see the process of inscribing in Inscribe Order.</p>
        <DialogFooter className="grid grid-cols-2 gap-2 w-full">
          <Button variant={"secondary"} className="bg-white8 w-full">
          Create again
          </Button>
          <Button>Go to Inscribe Order</Button>
        </DialogFooter>
        <button
