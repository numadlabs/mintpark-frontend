        ...
        {detail && (
          ...
          >
            ...
            <TabsContent value="All">
              ...
              >
                {filteredCollectibles.map((item: CollectibleSchema) => (
                  <div key={item.id}>
...
// export default function Assets({ detail = false }) {
//   const params = useParams();
//   const userId = params?.id as string;
//   const [active, setActive] = useState(false);
//   const [orderBy, setOrderBy] = useState("recent");
...
//     if (collectionIds) {
//       const selectedCollections = collectionIds.split(',').filter(Boolean);
...
//         filtered = filtered.filter((item: CollectibleSchema) =>
//           selectedCollectionNames.includes(item.collectionName)
//         );
//       }
//     }

//     return filtered;
//   }, [data?.data?.collectibles, data?.data?.collections, searchQuery, availability, collectionIds]);
...
//                 className={`grid w-full gap-4 sm:gap-6 ${
//                   active
//                     ? "grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 2xl:grid-cols-5 3xl:grid-cols-6"
//                     : "grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 2xl:grid-cols-5 3xl:grid-cols-6"
//                 }`}
//               >
//                 {filteredCollectibles.map((item: CollectibleSchema) => (
